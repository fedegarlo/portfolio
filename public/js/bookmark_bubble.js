...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = 'Instala esta app en tu m&oacute;vil: ' +
        'toca abajo y luego <b>\'A&ntilde;adir a Pantalla Inicio\'</b>';
  } else {
    bubbleInner.innerHTML = 'Instala esta app en tu móvil: ' +
        'toca <b style="font-size:15px">+</b> y luego ' +
        '<b>\'Añadir a Pantalla Inicio\'</b>';
  }
